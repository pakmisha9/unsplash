        ...
        <div>
          <div class="mb-10 lg:flex-row flex-col flex justify-between lg:items-center">
            <div class="flex items-center lg:mb-0 mb-5 lg:max-w-xl">
              <div v-if="item.user.profile_image.medium" class="overflow-hidden rounded">
                <img :src="item.user.profile_image.medium" alt="" />
              </div>
              <div class="text-white ml-3">
                <p v-if="item.user.first_name" class="text-3xl mb-1">{{ item.user.first_name }}</p>
                <a v-if="item.user.social.portfolio_url" :href="item.user.social.portfolio_url" target="_blank" class="text-sm">{{ item.user.social.portfolio_url }}</a>
              </div>
            </div>
            <div class="flex items-center">
              ...
              <a v-if="item.urls.regular" :download="item.urls.regular" href="#" class="bg-yellow-400 px-7 flex items-center rounded-lg h-12">
          ...
          <div v-if="item.urls.regular" class="rounded-lg w-full overflow-hidden h-[400px] md:h-[500px] lg:h-[600px] 2xl:h-[700px]">
